...
The size of the dots shows what proportion the different ages have within the east and the rest, while color indicates how big the difference between the regions is. The East has relatively fewer people around 20, and more people 60+.
...
ggplot(inc_by_age_reg_dis, aes(x = age, size = rel_diff, y = disease, colour=region)) +
  geom_point(stat = "identity", position = position_jitter(width=0.3, height=1), alpha = 0.3) +
...
season over time facet disease

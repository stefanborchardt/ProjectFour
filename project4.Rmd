...
qplot(data=long_inc, x=incidence, geom="histogram", binwidth=0.3, 
...
Norovirus is on the rise while rotavirus infections are declining. Immunization
shots against rotavirus have been available since 2006 and became officially
recommended (and paid for) in 2013.
...
were not available for questions. First, I try to replicate the last plot:
...
```{r echo=FALSE, fig.width=10, fig.height=7, cache=TRUE, Univariate_Plots11a}
...
```{r echo=FALSE, fig.width=10, fig.height=5, cache=TRUE, Univariate_Plots12}
...
```{r echo=FALSE, fig.width=10, fig.height=5, cache=TRUE, Univariate_Plots12a}
...
```{r echo=FALSE, fig.width=10, fig.height=5, cache=TRUE, Univariate_Plots13}
...
```{r echo=FALSE, fig.width=10, fig.height=7, warning=FALSE, cache=TRUE, Bivariate_Plots1}
...
```{r echo=FALSE, fig.width=10, fig.height=7, warning=FALSE, cache=TRUE, Bivariate_Plots3}
...
```{r echo=FALSE, fig.width=10, fig.height=7, warning=FALSE, cache=TRUE, Bivariate_Plots3a}
...
```{r echo=FALSE, fig.width=10, fig.height=7, cache=TRUE, Bivariate_Plots4}
...
```{r echo=FALSE, fig.width=10, fig.height=5, cache=TRUE, Bivariate_Plots5}
...
```{r echo=FALSE, fig.width=10, fig.height=3, cache=TRUE, Bivariate_Plots7}
...
```{r echo=FALSE, fig.width=10, fig.height=4, cache=TRUE, Multivariate_Plots5}
...
ggplot(mean_inc_by_age_dis, 
  ...
  labs(x = "Age", y = "Disease", size = "Incidence", title = "Incidence vs. Age" ) +
...
ggplot(weekly_inc_by_dis, aes(x = week, y = incidence, fill = disease)) +
  ...
  scale_fill_manual(values = rainbow_hcl(4),
                    ...
                    labels = c("norovirus", "rotavirus", 
                              "campylobacter", "salmonella")) +
  labs(x = "Week of the Year", y = "Incidence", fill = "Disease", title = "Incidence vs. Season" ) + 
